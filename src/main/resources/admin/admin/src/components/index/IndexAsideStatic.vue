<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"padding":"0","listStyle":"none","margin":"0","borderColor":"#b96d62","background":"#FFF","borderWidth":"0 0 0 10px","position":"relative","borderStyle":"solid"}' class="el-menu-vertical-demo" default-active="0">
				<el-image v-if="true" :style='{"width":"50px","margin":"10px auto","objectFit":"cover","borderRadius":"50%","display":"block","height":"50px"}' src="http://codegen.caihongy.cn/20220718/d92f632ba1804f34bd73e9da7b004471.png" fit="cover"></el-image>
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						color: #333;
						background: linear-gradient(180deg, #F6E1CD 0%, #FFF2E7 100%);
					}
